...
LangString MajoCliPathPageTitle ${LANG_RUSSIAN} "Command line"
LangString MajoCliPathPageSubtitle ${LANG_RUSSIAN} "Choose whether Majo is available in terminals."
LangString MajoCliPathPageDescription ${LANG_RUSSIAN} "This adds the bundled Majo command to your user PATH. You can change it later by reinstalling or uninstalling Majo Desktop."
LangString MajoCliPathCheckbox ${LANG_RUSSIAN} "Add Majo to PATH"
LangString MajoCliPathAdded ${LANG_RUSSIAN} "Added Majo to user PATH"
LangString MajoCliPathSkipped ${LANG_RUSSIAN} "Skipped adding Majo to user PATH"
LangString MajoCliPathMissing ${LANG_RUSSIAN} "Majo.exe was not found; skipped PATH update"
LangString MajoCliPathUpdateFailed ${LANG_RUSSIAN} "Failed to update user PATH"
LangString MajoStopBackendPrompt ${LANG_RUSSIAN} "Majo всё ещё запущен и использует файлы, которые установщику нужно заменить.$\n$\nЗакройте Majo (проверьте системный трей), затем нажмите «Повторить», чтобы продолжить. Нажмите «Отмена», чтобы прервать установку."
