...
LangString MajoCliPathPageTitle ${LANG_SIMPCHINESE} "命令行"
LangString MajoCliPathPageSubtitle ${LANG_SIMPCHINESE} "选择是否让终端可以直接使用 Majo。"
LangString MajoCliPathPageDescription ${LANG_SIMPCHINESE} "这会把随包提供的 Majo 命令加入你的用户 PATH。之后可通过重新安装或卸载 Majo Desktop 变更。"
LangString MajoCliPathCheckbox ${LANG_SIMPCHINESE} "将 Majo 添加到 PATH"
LangString MajoCliPathAdded ${LANG_SIMPCHINESE} "已将 Majo 添加到用户 PATH"
LangString MajoCliPathSkipped ${LANG_SIMPCHINESE} "已跳过添加 Majo 到用户 PATH"
LangString MajoCliPathMissing ${LANG_SIMPCHINESE} "未找到 Majo.exe，已跳过 PATH 更新"
LangString MajoCliPathUpdateFailed ${LANG_SIMPCHINESE} "更新用户 PATH 失败"
LangString MajoStopBackendPrompt ${LANG_SIMPCHINESE} "Majo 仍在运行，正占用安装程序需要替换的文件。$\n$\n请先退出 Majo（注意查看系统托盘），然后点击“重试”继续；点击“取消”将中止安装。"
