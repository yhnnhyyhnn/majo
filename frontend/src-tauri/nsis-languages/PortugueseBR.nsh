...
LangString MajoCliPathPageTitle ${LANG_PORTUGUESEBR} "Command line"
LangString MajoCliPathPageSubtitle ${LANG_PORTUGUESEBR} "Choose whether Majo is available in terminals."
LangString MajoCliPathPageDescription ${LANG_PORTUGUESEBR} "This adds the bundled Majo command to your user PATH. You can change it later by reinstalling or uninstalling Majo Desktop."
LangString MajoCliPathCheckbox ${LANG_PORTUGUESEBR} "Add Majo to PATH"
LangString MajoCliPathAdded ${LANG_PORTUGUESEBR} "Added Majo to user PATH"
LangString MajoCliPathSkipped ${LANG_PORTUGUESEBR} "Skipped adding Majo to user PATH"
LangString MajoCliPathMissing ${LANG_PORTUGUESEBR} "Majo.exe was not found; skipped PATH update"
LangString MajoCliPathUpdateFailed ${LANG_PORTUGUESEBR} "Failed to update user PATH"
LangString MajoStopBackendPrompt ${LANG_PORTUGUESEBR} "O Majo ainda está em execução e está usando arquivos que o instalador precisa substituir.$\n$\nFeche o Majo (verifique a bandeja do sistema) e clique em Repetir para continuar. Clique em Cancelar para abortar a instalação."
