...
LangString MajoCliPathPageTitle ${LANG_ENGLISH} "Command line"
LangString MajoCliPathPageSubtitle ${LANG_ENGLISH} "Choose whether Majo is available in terminals."
LangString MajoCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled Majo command to your user PATH. You can change it later by reinstalling or uninstalling Majo Desktop."
LangString MajoCliPathCheckbox ${LANG_ENGLISH} "Add Majo to PATH"
LangString MajoCliPathAdded ${LANG_ENGLISH} "Added Majo to user PATH"
LangString MajoCliPathSkipped ${LANG_ENGLISH} "Skipped adding Majo to user PATH"
LangString MajoCliPathMissing ${LANG_ENGLISH} "Majo.exe was not found; skipped PATH update"
LangString MajoCliPathUpdateFailed ${LANG_ENGLISH} "Failed to update user PATH"
LangString MajoStopBackendPrompt ${LANG_ENGLISH} "Majo is still running and is using files the installer needs to replace.$\n$\nPlease quit Majo (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
